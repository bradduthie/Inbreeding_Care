...
\vspace{15 mm}
\noindent Word count: 5,022 (excluding legends, appendices, and references). Abstract word count: 200
...
% That the first term *equal* the rhs of Eq 1 doesn't really matter -- what matters is that it is *identical* -- i.e., not that the maths works out to be the same, but that the theory derives from the same place.
