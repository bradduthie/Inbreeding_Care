...
% TODO: As worded, ''explaining self-sacrificial behaviour that increases reproductive success of related beneficiaries'' doesn't make sense to me. The increase in reproductive success of relatives *is* the explanation, not the thing we're trying to explain, so I've reworded to make the connection clearer.
