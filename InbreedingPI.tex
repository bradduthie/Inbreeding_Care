...
\vspace{15 mm}
\noindent Word count: 4,638 (excluding legends, appendices, and references). Abstract word count: 200
...
% End of first paragraph (assuming focal parents are outbred, so $f=0$ and $r=2k$ as in Eq 1)
...
% This is a broader point -- I'm not sure how else to put this. Assumptions do not have to be 'reasonable' or 'sensible'; they have to be useful. It is possible (though less common) for unreasonable assumptions to be useful (e.g., to provide contrast with biologically reasonable assumptions, to delineate goalposts for a middle ground of possible outcomes, or perhaps just to more cleary highlight important logical connections from assumptions -> predictions). I've removed any qualifier to 'assumptions', as I don't want to shift the focus too much, but I think this is at the heart of what makes theory like this useful. The assumptions facilitate conceptual insight, not (exclusively or primarily) prediction.
