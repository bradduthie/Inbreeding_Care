...
\item{Grafen, A., 2006 {Optimization of inclusive fitness}. \textit{Journal of
  Theoretical Biology} \textbf{238}, 541--563,
  \doi{10.1016/j.jtbi.2005.06.009}.}

\item{Bourke, A. F.~G., 2014 {Hamilton's rule and the causes of social evolution}.
  \textit{Philosophical Transactions of the Royal Society B} \textbf{369},
  20130362, \doi{10.1098/rstb.2013.0362}.}

\item{Fisher, R.~M., Cornwallis, C.~K. \& West, S.~A., 2013 {Group formation,
  relatedness, and the evolution of multicellularity}. \textit{Current Biology}
  \textbf{23}, 1120--1125, \doi{10.1016/j.cub.2013.05.004}.}

\item{Gardner, A. \& West, S.~A., 2014 {Inclusive fitness: 50 years on}.
  \textit{Philosophical Transactions of the Royal Society B} \textbf{369},
  20130356.}

\item{Liao, X., Rong, S. \& Queller, D.~C., 2015 {Relatedness, conflict, and the
  evolution of eusociality}. \textit{PLoS Biology} \textbf{13}, 1--14,
  \doi{10.1371/journal.pbio.1002098}.}

\item{Frank, S.~A., 2013 {Natural selection. VII. History and interpretation of kin
  selection theory}. \textit{Journal of Evolutionary Biology} \textbf{26},
  1151--1184, \doi{10.1111/jeb.12131}.}

\item{Hamilton, W.~D., 1964 {The genetical evolution of social behaviour. I}.
  \textit{Journal of Theoretical Biology} \textbf{7}, 1--16.}


\item{Hamilton, W.~D., 1964 {The genetical evolution of social behaviour. II}.
  \textit{Journal of Theoretical Biology} \textbf{7}, 17--52.}

\item{Parker, G.~A., 2006 {Sexual conflict over mating and fertilization: an
  overview}. \textit{Philosophical Transactions of the Royal Society B}
  \textbf{361}, 235--259, \doi{10.1098/rstb.2005.1785}.}

\item{K{\"{o}}lliker, M., Boos, S., Wong, J. W.~Y., R{\"{o}}llin, L., Stucki, D.,
  Raveh, S., Wu, M. \& Meunier, J., 2015 {Parent-offspring conflict and the
  genetic trade-offs shaping parental investment}. \textit{Nature
  Communications} \textbf{6}, 6850, \doi{10.1038/ncomms7850}.}
...
\item{Trivers, R., 1974 {Parent-Offspring Conflict}. \textit{American Zoologist}
  \textbf{14}, 249--264, \doi{10.1093/icb/14.1.249}.}

\item{Parker, G.~A., 1979 {Sexual selection and sexual conflict}, in \textit{Sexual
  selection and reproductive competition in insects} (eds. M.~S. Blum \& N.~A.
  Blum), pp. 123--166, New York: Academic Press, Inc.}

\item{Duthie, A.~B. \& Reid, J.~M., 2015 {What happens after inbreeding avoidance?
...
\item{Reid, J.~M., Bocedi, G., Nietlisbach, P., Duthie, A.~B., Matthew, E., Gow,
  E.~A. \& Arcese, P., 2016 {Variation in parent-offspring kinship in socially
  monogamous systems with extra-pair reproduction and inbreeding}.
  \textit{Evolution} \doi{10.1111/evo.12953}.}

\item{Szulkin, M., Stopher, K.~V., Pemberton, J.~M. \& Reid, J.~M., 2013 {Inbreeding
  avoidance, tolerance, or preference in animals?} \textit{Trends in Ecology
  {\&} Evolution} \textbf{28}, 205--211, \doi{10.1016/j.tree.2012.10.016}.}

\item{Waser, P.~M., Austad, S.~N. \& Keane, B., 1986 {When should animals tolerate
  inbreeding?} \textit{American Naturalist} \textbf{128}, 529--537.}

\item{{De Jong}, T.~J., {Van Dijk}, H. \& Klinkhamer, P. G.~L., 2005 {Hamilton's
  rule, imprinting and parent-offspring conflict over seed mass in partially
  selfing plants}. \textit{Journal of Evolutionary Biology} \textbf{18},
  676--682, \doi{10.1111/j.1420-9101.2004.00856.x}.}

\item{Kuijper, B. \& Johnstone, R.~A., 2012 {How dispersal influences
  parent-offspring conflict over investment}. \textit{Behavioral Ecology}
  \textbf{23}, 898--906, \doi{10.1093/beheco/ars054}.}

\item{Macnair, M.~R. \& Parker, G.~A., 1978 {Models of parent-offspring conflict. II.
  Promiscuity}. \textit{Animal Behaviour} \textbf{26}, 111--122,
  \doi{10.1016/0003-3472(78)90010-6}.}

\item{Parker, G.~A., 1985 {Models of parent-offspring conflict. V. Effects of the
  behaviour of the two parents}. \textit{Animal Behaviour} \textbf{33},
  519--533, \doi{10.1016/S0003-3472(85)80075-0}.}

\item{Parker, G.~A. \& Macnair, M.~R., 1978 {Models of parent-offspring conflict. I.
  Monogamy}. \textit{Animal Behaviour} \textbf{26}, 97--110,
  \doi{10.1016/0003-3472(78)90009-X}.}

\item{Charlesworth, D. \& Willis, J.~H., 2009 {The genetics of inbreeding
  depression}. \textit{Nature Reviews Genetics} \textbf{10}, 783--796,
  \doi{10.1038/nrg2664}.}

\item{O'Grady, J.~J., Brook, B.~W., Reed, D.~H., Ballou, J.~D., Tonkyn, D.~W. \&
  Frankham, R., 2006 {Realistic levels of inbreeding depression strongly affect
  extinction risk in wild populations}. \textit{Biological Conservation}
  \textbf{133}, 42--51.}

\item{Penn, D.~J. \& Frommen, J.~G., 2010 {Kin recognition: an overview of conceptual
...
\item{Hamilton, W.~D., 1972 {Altruism and related phenomena, mainly in social
  insects}. \textit{Annual Review of Ecology and Systematics} \textbf{3},
  193--232.}

\item{Michod, R.~E. \& Anderson, W.~W., 1979 {Measures of genetic relationship and
  the concept of inclusive fitness}. \textit{American Naturalist} \textbf{114},
  637--647.}

\item{Keller, L.~F. \& Waller, D.~M., 2002 {Inbreeding effects in wild populations}.
  \textit{Trends in Ecology {\&} Evolution} \textbf{17}, 19--23.}

\item{Parker, G.~A., Royle, N.~J. \& Hartley, I.~R., 2002 {Intrafamilial conflict and
  parental investment: a synthesis.} \textit{Philosophical Transactions of the
  Royal Society B} \textbf{357}, 295--307, \doi{10.1098/rstb.2001.0950}.}

\item{Pilakouta, N., Jamieson, S., Moorad, J.~A. \& Smiseth, P.~T., 2015 {Parental
  care buffers against inbreeding depression in burying beetles}.
  \textit{Proceedings of the National Academy of Sciences} \textbf{112},
  201500658, \doi{10.1073/pnas.1500658112}.}

\item{Avil{\'{e}}s, L. \& Bukowski, T.~C., 2006 {Group living and inbreeding
  depression in a subsocial spider}. \textit{Proceedings of the Royal Society
  B} \textbf{273}, 157--163, \doi{10.1098/rspb.2005.3308}.}

\item{Fredrickson, R.~J., Siminski, P., Woolf, M. \& Hedrick, P.~W., 2007 {Genetic
  rescue and inbreeding depression in Mexican wolves.} \textit{Proceedings of
  The Royal Society B} \textbf{274}, 2365--2371, \doi{10.1098/rspb.2007.0785}.}

\item{Liberg, O., Andr{\'{e}}n, H., Pedersen, H.-C., Sand, H., Sejberg, D., Wabakken,
  P., Kesson, M. \& Bensch, S., 2005 {Severe inbreeding depression in a wild
  wolf (\textit{Canis lupus}) population}. \textit{Biology letters} \textbf{1}, 17--20,
  \doi{10.1098/rsbl.2004.0266}.}

\item{Geffen, E., Kam, M., Hefner, R., Hersteinsson, P., Angerbj{\"{o}}rn, A.,
  Dal{\`{e}}n, L., Fuglei, E., Nor{\`{e}}n, K., Adams, J.~R., Vucetich, J.,
  Meier, T.~J., Mech, L.~D., Vonholdt, B.~M., Stahler, D.~R. \& Wayne, R.~K.,
...
\item{R{\"{a}}ikk{\"{o}}nen, J., Vucetich, J.~A., Peterson, R.~O. \& Nelson, M.~P.,
  2009 {Congenital bone deformities and the inbred wolves (\textit{Canis lupus}) of Isle
  Royale}. \textit{Biological Conservation} \textbf{142}, 1025--1031,
  \doi{10.1016/j.biocon.2009.01.014}.}

\item{Maynard Smith, J., 1977 {Parental investment: A prospective analysis}.
  \textit{Animal Behaviour} \textbf{25}, 1--9,
  \doi{10.1016/0003-3472(77)90062-8}.}

\item{Mattey, S.~N., 2014 \textit{{Social effects of inbreeding associated with
