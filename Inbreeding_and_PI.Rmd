...
<!--- I have tweaked the focus here to more broadly put things in the context of natural selection, partly in attempt to avoid assuming that readers will make the connection between the direction of selection and the consequences of inclusive fitness. I don't think that the point is really to predict what individuals might or might not do and the fitness consequences that follow, but instead to focus on how selection is predicted to affect adaptation -- I've written it in this way now so that the connection between the fitness consequences for focal individuals are more clearly connected to the general goal of understanding natural selection, rather than on understanding what happens for focal individuals themselves. Previously, this last sentence read, ''Individuals that inbreed will increase their fitness by increasing their per offspring parental investment and decreasing their total reproductive output, relative to outbreeders.'' --->
